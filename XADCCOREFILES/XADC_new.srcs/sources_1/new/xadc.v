...
module xadc(reset, i_clk, ja, led); 
...
xadc_wiz_0 myxadc (         //XADC wizard initialization
   ...
   always@(posedge i_clk)
    ...
    always@(posedge i_clk) begin
        if ((_drdy == 2'b10)) //on negative edge of drdy signal (cannot use negedge for XADC outputs) since drdy is an output of XADC,
                              //we cannot use the "negedge" keyword for it
        begin
